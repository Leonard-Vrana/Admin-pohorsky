<div class="fixed top-0 h-full w-full z-[180] -left-[100vw] duration-500 pointer-events-none" id="deleteMenu">
    <div class="flex justify-center items-center h-full">
        <form method="post" action="{{ route("admin-deleteMenu") }}">
            @csrf
