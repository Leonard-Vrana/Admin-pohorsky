<div class="fixed top-0 h-full w-full z-[180] -left-[100vw] duration-500 pointer-events-none" id="addTerm">
    <div class="flex justify-center items-center h-full">
        <form method="post" action="{{ route("admin-storyCreateTerms") }}">
            @csrf
            ...
            <div class="w-full px-6 py-4 overflow-hidden bg-white rounded-t-lg dark:bg-gray-800 sm:rounded-lg sm:m-4 sm:max-w-xl pointer-events-auto">
                ...
                <div class="mt-4 mb-6">
                  ...
                  <p class="text-xl text-gray-700 dark:text-gray-400 text-center">
                    <input type="text" name="nameAuthor" placeholder="Meno Autora" class="nameAuthor block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="" />
                  </p>
                </div>
